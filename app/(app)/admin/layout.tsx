...
import { type Role, can, isSuperAdmin } from "@/lib/permissions";
...
const NAV_MAIN = [
  { href: "/admin/dashboard",   label: "Дашборд",       icon: "dashboard",   superadminOnly: false },
  { href: "/admin/users",       label: "Користувачі",   icon: "users",       superadminOnly: false },
  { href: "/admin/blog",        label: "Блог",           icon: "blog",        superadminOnly: false },
  { href: "/admin/tickets",     label: "Тикети",         icon: "tickets",     superadminOnly: false },
  { href: "/admin/tasks",       label: "Завдання",       icon: "tasks",       superadminOnly: false },
  { href: "/admin/api",         label: "API",            icon: "api",         superadminOnly: false },
  { href: "/admin/permissions", label: "Права доступу", icon: "permissions", superadminOnly: true  },
];
  ...
  return (
    <div className="flex flex-col h-full bg-neutral-950 text-white">
      ...
      <nav className="flex-1 px-3 py-4 space-y-0.5">
        {NAV_MAIN.filter(item => !item.superadminOnly || isSuperAdmin(role)).map(({ href, label, icon }) => (
